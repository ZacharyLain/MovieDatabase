  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.println("<center><table border='1'><tr BGCOLOR='#cc cccc'>" +
                  "<td>ID</td><td>First Name</td><td>Last Name</td><td>Gender</td><td>Compensation</td></tr>");

      String sort = request.getParameter("sort");
      String query = "SELECT p.p_id, p.p_firstName, p.p_lastName, p.p_gender, SUM(mpr.compensation) AS compensation FROM person p " +
